...
const CalendarScreen = ({ navigation }) => {
  ...
  // Array of time slots from 12:00 AM to 11:59 PM
  const timeSlots = Array.from({ length: 24 }, (_, i) => ({
    time: `${i === 0 ? 12 : i > 12 ? i - 12 : i}:00 ${i < 12 ? 'AM' : 'PM'}`
  }));
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        {/* Daily Calendar View */}
        <View style={styles.dailyCalendarContainer}>
          <Text style={styles.dailyCalendarTitle}>Daily Schedule</Text>
          <FlatList
            data={timeSlots}
